...
Write-Host ""
Write-Host "Hotkeys in game: F8 world dump, F9 UI dump, F5 input/keybind dump, F7 tracker toggle, F11 navmesh probe, F12 pickup watch (CTRL+key also works)." -ForegroundColor Green
